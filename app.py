...
# --- MOTOR DE IA CON TEMPERATURA 0.0 Y VERIFICACIÓN MATEMÁTICA DE TIPOS ---
def analyze_with_ai(clean_actions_text, user_name, opponent_name, user_won, my_leads, opp_leads, my_team, opp_team, archetype):
    ...
    1. TABLA DE TIPOS RIGUROSA: Verifica doblemente las combinaciones de tipos antes de declarar debilidades. Ejemplo: Excadrill (Acero/Tierra) RESISTE Hada y es NEUTRO a Hielo; NUNCA digas que es débil a esos tipos.
    2. NOMBRES LITERALEZ DE MOVIMIENTOS: Usa ÚNICAMENTE los nombres exactos de los movimientos presentes en el log. Si el log no contiene "Zap Cannon", está PROHIBIDO escribir esa palabra.
    ...
    <p>🎯 <b>4. Plan de Ajuste Táctico para el Game 2:</b><br>[Instrucción concreta para el siguiente juego: cambios de lead, prioridades o jugadas defensivas]</p>
    """
